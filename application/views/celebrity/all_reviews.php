                        ...
                        if (isset($data1)) {
                            foreach ($data1 as $row) {
                                ...
                                <div class="middle_article">
                                    <a href="<?= base_url('main/celebrity_click/') . $row->id ?>" class="article_title">
                                        <?= $row->title ?>
                                    </a>
                                    ...
                                    <div class="middle_art_main">
                                        ...
                                        <a href="<?= base_url('main/celebrity_click/') . $row->id ?>" class="article_a">
                                        <img src="<?= base_url('./upload/celebrity/' . $row->image1) ?>" alt="">
                                        </a>
                                        </div>
