...
<div class="app-title">
        <div>
            <h1><i class="bi bi-cricket"></i>Edit News Page</h1>
        </div>
    </div>
                ...
                <div class="tile-body">
                    <form action="<?= base_url('admin/update_news') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="<?=base_url('./upload/news/').$data1[0]->image1?>" width="200" height="150">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="<?=base_url('./upload/news/').$data1[0]->image2?>" alt=""  width="200" height="150">
