...
<div class="app-title">
        <div>
            <h1><i class="bi bi-cricket"></i>Edit Hollywood Page</h1>
        </div>
    </div>
    <div class="row form_upload_main">
        ...
        <div class="col-md-12 col-lg-8">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form action="<?= base_url('admin/update_hollywood') ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="<?=base_url('./upload/hollywood/').$data1[0]->image1?>" width="200" height="150">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="<?=base_url('./upload/hollywood/').$data1[0]->image2?>" alt=""  width="200" height="150">
