                        ...
                        if (isset($data1)) {
                            foreach ($data1 as $row) {
                                ...
                                <div class="middle_article">
                                    <a href="<?= base_url('main/videos_click/') . $row->id ?>" class="article_title">
                                        <?= $row->title ?>
                                    </a>
                                    ...
                                    <div class="middle_art_main">
                                        ...
                                        <a href="<?= base_url('main/videos_click/') . $row->id ?>" class="article_a">
                                        <video src="<?= base_url('./upload/videos/' . $row->video1) ?>" alt="">
                                        </a>
                                        </div>
