                ...
                <div class="left_card">
                    ...
                    <div class="desc_design">
                        ...
                        <div class="desc_inner">
                            ...
                            <ul class="icon_share">
                                <li class="share_list"><a href="http://www.facebook.com/sharer.php?s=100&p[summary]=SUMMARY&p<?php echo base_url()?>=URL&p<?php echo $data2[0]->title?>=TITLE" target="_blank" class="share_link facebook"><i class="fab fa-facebook"></i></a></li>
                                ...
                                <li class="share_list"><a href="https://api.whatsapp.com/send?text=<?=base_url('main/videos_click/') . $data2[0]->id .'/' . $data2[0]->title?>" target="_blank" class="share_link whatsapp"><i class="fab fa-whatsapp"></i></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="desc_main">
                        ...
                        <div class="desc_vd mb-3 mt-3">
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video1?>" 
                                alt=""></video>
                        </div>
                        <p></p>
                    </div>
                    <div class="desc_main1">
                        <div class="desc_vd1 mb-3 mt-3">
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video2?>" 
                                alt=""></video>
                        </div>
                        <p></p>
                    </div>
                    <div class="desc_main1">
                        <div class="desc_vd1 mb-3 mt-3">
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video3?>"
                                alt=""></video>
                        </div>
                        <p></p>
                    </div>
                    <div class="desc_main1">
                        <div class="desc_vd1 mb-3 mt-3">
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video4?>" 
                                alt=""></video>
                        </div>
                        <p></p>
                    </div>
                    <div class="desc_main1">
                        <div class="desc_vd1 mb-3 mt-3">
                            <video src="<?=base_url('./upload/videos/').$data2[0]->video5?>"
                                alt=""></video>
                        </div>
                        <p></p>
                    </div>
