                        ...
                        if (isset($data1)) {
                            foreach ($data1 as $row) {
                                ...
                                <div class="middle_article">
                                    <a href="<?= base_url('main/photos_click/') . $row->id ?>" class="article_title">
                                        <?= $row->title ?>
                                    </a>
                                    ...
                                    <div class="middle_art_main">
                                        ...
                                        <a href="<?= base_url('main/photos_click/') . $row->id ?>" class="article_a">
                                        <img src="<?= base_url('./upload/photos/' . $row->image1) ?>" alt="">
                                        </a>
                                        </div>
