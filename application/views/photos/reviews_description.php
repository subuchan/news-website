                ...
                <div class="left_card">
                    ...
                    <div class="desc_design">
                        ...
                        <div class="desc_inner">
                            ...
                            <ul class="icon_share">
                                ...
                                <li class="share_list"><a href="https://api.whatsapp.com/send?text=<?= base_url() . $_SERVER['REQUEST_URI']; ?>" target="_blank"  class="share_link whatsapp"><i class="fab fa-whatsapp"></i></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="desc_main">
                        ...
                        <div class="desc_img mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image1?>"
                                alt="">
                        </div>
                        <p></p>
                    </div>
                    <div class="desc_main1">
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image2?>"
                                alt="">
                        </div>

                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image3?>"
                                alt="">
                        </div>
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image4?>"
                                alt="">
                        </div>
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image5?>"
                                alt="">
                        </div>
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image6?>"
                                alt="">
                        </div>
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image7?>"
                                alt="">
                        </div>
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image8?>"
                                alt="">
                        </div>
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image9?>"
                                alt="">
                        </div>
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/photos/').$data2[0]->image10?>"
                                alt="">
                        </div>
                        <p></p>
                    </div>
