                    ...
                    <?php
                        ...
                        <div class="col-lg-4" id="main_col">
                                <div class="middle_article" id="home_flex">
                                    <a href="<?= base_url('main/home_click_review/') . $row->id ?>" class="article_title">
                                        <?= $row->title ?>
                                    </a>
                                    ...
                                    <div class="middle_art_main">
                                        ...
                                        <a href="<?= base_url('main/home_click_review/') . $row->id ?>" class="article_a">
                                        <img src="<?= base_url('./upload/home/' . $row->image1) ?>" alt="">
                                        </a>
                                        </div>
