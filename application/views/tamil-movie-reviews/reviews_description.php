                ...
                <div class="left_card">
                    ...
                    <div class="desc_design">
                        ...
                        <div class="desc_inner">
                            ...
                            <ul class="icon_share">
                                <li class="share_list"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fnewsghuru.in%2F" class="share_link facebook"><i class="fab fa-facebook"></i></a></li>
                                <li class="share_list"><a  href="https://www.instagram.com/sharer.php?u={{http%3A%2F%2Fnewsghuru.in%2F()->current()}}" class="share_link instagram"><i class="fab fa-instagram"></i></a></li>
                                <li class="share_list"><a href="http://twitter.com/share?text=[TITLE]&url=[URL]" class="share_link twitter"><i class="fab fa-twitter"></i></a></li>
                                <li class="share_list"><a href="https://api.whatsapp.com/send?text=<?php echo base_url().$_SERVER['REQUEST_URI']; ?>" data-link="<?php echo base_url() . $_SERVER['REQUEST_URI']; ?>" target="_blank" class="share_link whatsapp"><i class="fab fa-whatsapp"></i></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="desc_main">
                        ...
                        <div class="desc_img mb-3 mt-3">
                            <img src="<?=base_url('./upload/tamil/').$data2[0]->image1?>"
                                alt="">
                        </div>
                        <p></p>
                    </div>
                    <div class="desc_main1">
                        ...
                        <div class="desc_img1 mb-3 mt-3">
                            <img src="<?=base_url('./upload/tamil/').$data2[0]->image2?>"
                                alt="">
                        </div>
                        <p></p>
                    </div>
