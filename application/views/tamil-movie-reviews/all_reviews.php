                    ...
                    <div class="middle_bar">
                        <div class="middle_tit">
                            ...
                            <div class="breadcrumbs">
                                <h1 class="bc_head">Tamil Movies Reviews</h1>
                            </div>
                        </div>
                        ...
                        if (isset($data1)) {
                            foreach ($data1 as $row) {
                                ...
                                <div class="middle_article">
                                    <a href="<?= base_url('main/tamil_click_review/') . $row->id ?>" class="article_title">
                                        <?= $row->title ?>
                                    </a>
                                    ...
                                    <div class="middle_art_main">
                                        ...
                                        <a href="<?= base_url('main/tamil_click_review/') . $row->id ?>" class="article_a">
